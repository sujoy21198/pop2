...
export default class EditProfile extends React.Component {
    ...
    getStateAndDist = async () => {
      ...
      var gramApi = []
      var villageApi = []
      let resState = await axios.get("http://161.35.122.165:3020/api/v1/zones", {
        headers: {
      ...
      if(resState.data.status == 1) {
        ...
        let resDist = await axios.get("http://161.35.122.165:3020/api/v1/districts?state="+this.state.stateName, {
            headers: {
                'Content-Type': 'application/json'
            }
        });
        ...
        let resBlock = await axios.get("http://161.35.122.165:3020/api/v1/blocks?district="+this.state.district, {
            headers: {
                'Content-Type': 'application/json'
            }
        });
        ...
        let resPanchayat = await axios.get("http://161.35.122.165:3020/api/v1/gram-panchayats?block="+this.state.block, {
            headers: {
                'Content-Type': 'application/json'
            }
        });
        ...
        let resVillages = await axios.get("http://161.35.122.165:3020/api/v1/villages?panchayat="+this.state.panchayat, {
            headers: {
                'Content-Type': 'application/json'
            }
        });
