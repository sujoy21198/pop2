...
export default class StepThreeScreen extends Component {
    ...
    getOfflineData = async () => {
        try {
            ...
            this.setState({ cropNameLanguageChangeArray: cropSpecificSteps[2].cropData })
    ...
    render() {
        ...
        return (
            <View style={{ backgroundColor: BaseColor.BackgroundColor, flex: 1 }}>
                ...
                <Text style={{ fontSize: widthToDp("6%"), marginLeft: widthToDp("3%"), marginTop: heightToDp("1%"), fontFamily: 'Oswald-Medium' }}>{this.state.stepLabel} - {this.state.pageNumber}/08</Text>
                {
