...
export default class StepOneScreen extends Component {
    ...
    getOnlSteps = async () => {
        try {
            ...
            cropNameLanguageChangeArray = cropFilter[3].cropData
            this.setState({ englishDescription: cropFilter[3].english })
            this.setState({ hindiDescription: cropFilter[3].hindi })
            this.setState({ hoDescription: cropFilter[3].ho })
            this.setState({ odiaDescription: cropFilter[3].odia })
            this.setState({ santhaliDescription: cropFilter[3].santhali })
            this.setState({ englishTitleDescription: cropFilter[3].nameEnglish })
            this.setState({ hindiTitleDescription: cropFilter[3].nameHindi })
            this.setState({ hoTitleDescription: cropFilter[3].nameHo })
            this.setState({ odiaTitleDescription: cropFilter[3].nameOdia })
            this.setState({ santhaliTitleDescription: cropFilter[3].nameSanthali })
            this.setState({ stepImage: cropFilter[3].imageFile })
